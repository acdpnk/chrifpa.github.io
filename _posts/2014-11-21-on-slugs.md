...
I'm thinking about trying a new permalink style. Here's an actual link from the blog, in the style I use now:
...
[^slugstyle]: The slug this post is using is a [Base36](http://en.wikipedia.org/wiki/Base_36) encoded UTC timestamp. Short and as good as collision free.
